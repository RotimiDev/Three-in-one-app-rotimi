...
public abstract class Hilt_ApiFetchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ApiFetchFragment() {
    super();
  }

  Hilt_ApiFetchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ApiFetchFragment_GeneratedInjector) this.generatedComponent()).injectApiFetchFragment(UnsafeCasts.<ApiFetchFragment>unsafeCast(this));
    }
  }
